        ...
        try {
            ...
            for (FormInstance fi : formInstances) {
                ...
                if (fi.getBooking() != null) {
                    ...
                    emptyBs.setStartDateTime(fi.getBooking().getBookingSlot().getStartDateTime());
                    emptyBs.setEndDateTime(fi.getBooking().getBookingSlot().getEndDateTime());
                    
                    Booking emptyBooking = new Booking();
                    emptyBooking.setBookingId(fi.getBooking().getBookingId());
