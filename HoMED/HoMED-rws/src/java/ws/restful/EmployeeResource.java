...
public class EmployeeResource {
    ...
    public Response getEmployee(@QueryParam("employeeId") String id) {
        ...
        try {
            ...
            return Response.status(Response.Status.OK).entity("Found Employee with id = " + id + " Name: " + employee.getName()).build();

        } catch (EmployeeNotFoundException ex) {
            return Response.status(Response.Status.BAD_REQUEST).entity("Unable to find Employee with id = " + id).build();
