...
//        formInstanceSessionBeanLocal.updateFormInstanceFieldValues(formInstance);
    ...
    private Long initializeForm() throws CreateConsultationPurposeException, CreateFormTemplateException, RelinkFormTemplatesException {
        ...
        formFields.add(new FormField("This question is a header", 2, InputTypeEnum.HEADER, Boolean.FALSE, Boolean.FALSE, null));
        formFields.add(new FormField("This question is a number", 3, InputTypeEnum.NUMBER, Boolean.TRUE, Boolean.TRUE, null));
        formFields.add(new FormField("This question is a Date", 4, InputTypeEnum.DATE, Boolean.TRUE, Boolean.TRUE, null));
        formFields.add(new FormField("This question is a Time", 5, InputTypeEnum.TIME, Boolean.TRUE, Boolean.TRUE, null));
        ...
        formFields.add(new FormField("This question is a Radio Button", 6, InputTypeEnum.RADIO_BUTTON, Boolean.TRUE, Boolean.TRUE, formFieldOptions));
        formFields.add(new FormField("This question is a Check Box", 7, InputTypeEnum.CHECK_BOX, Boolean.TRUE, Boolean.TRUE, formFieldOptions));
        formFields.add(new FormField("This question is a Single Dropdown", 8, InputTypeEnum.SINGLE_DROPDOWN, Boolean.TRUE, Boolean.TRUE, formFieldOptions));
        formFields.add(new FormField("This question is a Multi Dropdown", 9, InputTypeEnum.MULTI_DROPDOWN, Boolean.TRUE, Boolean.TRUE, formFieldOptions));
        formFields.add(new FormField("This question is a File Upload", 10, InputTypeEnum.FILE_UPLOAD, Boolean.TRUE, Boolean.TRUE, null));
        formFields.add(new FormField("This question is a Image Upload", 11, InputTypeEnum.IMAGE_UPLOAD, Boolean.TRUE, Boolean.TRUE, null));
