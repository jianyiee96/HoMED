...
public class DataInitializationSessionBean {
    ...
    private void initializeData() {
        try {
            ...
            String employee1OTP = employeeSessionBeanLocal.createEmployee(new Admin("Admin OTP", "s1234567d", "hew1521@hotmail.com", "30 Jalan Klinik", 94362875));
            ...
            String serviceman1OTP = servicemanSessionBeanLocal.createNewServiceman(new Serviceman("Amos Tan Ah Kow", "s7654321d", "98765432", new Date(), GenderEnum.MALE, BloodTypeEnum.BP, "hew1521@hotmail.com", "13 Computing Drive"));
