...
public class DataInitializationSessionBean {
    ...
    private void initializeData() {
        try {
            ...
            String serviceman2OTP = servicemanSessionBeanLocal.createNewServiceman(new Serviceman("Brandon Tan", "S7654321e", "98765434", new Date(), GenderEnum.MALE, BloodTypeEnum.BP, "dummyemailxxx124@gmail.com", "14 Computing Drive"));
            String serviceman3OTP = servicemanSessionBeanLocal.createNewServiceman(new Serviceman("Charles Lim", "S7654321f", "98765435", new Date(), GenderEnum.MALE, BloodTypeEnum.BP, "dummyemailxxx125@gmail.com", "15 Computing Drive"));
